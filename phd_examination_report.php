...
<head>
    ...
    <title>PhD Examination Report</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#example').dataTable({
                ...
                "sAjaxSource":"phd_examination_process.php",
                "sScrollX":"100%",
                //"sScrollXInner": "150%",
            ...
            $("#example tbody").click(function (event) {
                ...
                $('#engo609_seminar').val(getSelectedInfo()[9]);
                $('#candidacy_exam').val(getSelectedInfo()[10]);
                $('#what_course_requirement').val(getSelectedInfo()[11]);
                $('#final_defense').val(getSelectedInfo()[12]);
            });
        });
        ...
        function getSelectedInfo() {
            ...
            var selected_engo609_seminar = oTable.fnGetData(data, 14);
            var selected_candidacy_exam = oTable.fnGetData(data, 15);
            var selected_final_defense = oTable.fnGetData(data, 16);
            var selected_what_course_requirement = oTable.fnGetData(data, 17);
            var infoArray = [selected_id, selected_first_name, selected_last_name, selected_final_gpa,
                ...
                selected_engo607_seminar, selected_engo609_seminar, selected_candidacy_exam, selected_what_course_requirement,
                selected_final_defense];
            return infoArray;
        }
    ...
    <div id="site_content">
        <div id="sidebar_animate" class="sidebar">
            ...
            <ul>
                ...
                <form id="report" method="post" target="_blank" action="phd_report_generator.php">
                    ...
                    <input type="hidden" id="engo609_seminar" name="engo609_seminar">
                    <input type="hidden" id="engo607_seminar" name="engo607_seminar">
                    <input type="hidden" id="final_defense" name="final_defense">
                    <input type="hidden" id="candidacy_exam" name="candidacy_exam">
                </form>
            </ul>
        </div>
        <div id="content">
            ...
            <h1><a href="student_dashboard.php" class=" breadcrumbs">Student
                Dashboard</a> > PhD Examination Clearance Report</h1>
            ...
            <div id="dynamic">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tr>
                        ...
                        <th>ENGO 609 Presentation Completed</th>
                        <th>Candidacy Exam</th>
                        <th>Final Defense</th>
