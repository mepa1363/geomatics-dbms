...
<head>
    ...
    <title>MSc Examination Report</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#example').dataTable({
                ...
                "sAjaxSource":"msc_examination_process.php",
                "sScrollX":"100%",
                //"sScrollXInner": "150%",
            ...
            $("#example tbody").click(function (event) {
                ...
                $('#engo605_reports').val(getSelectedInfo()[7]);
                $('#engo605_seminar').val(getSelectedInfo()[8]);
                $('#final_defense').val(getSelectedInfo()[9]);
            });
        });
        ...
        function getSelectedInfo() {
            ...
            var selected_engo605_reports = oTable.fnGetData(data, 12);
            var selected_engo605_seminar = oTable.fnGetData(data, 13);
            var selected_final_defense = oTable.fnGetData(data, 14);
            var infoArray = [selected_id, selected_first_name, selected_last_name, selected_final_gpa,
                selected_course_requirement, selected_technical_writing, selected_supervisor, selected_engo605_reports,
                selected_engo605_seminar, selected_final_defense];
            return infoArray;
        }
    ...
    <div id="site_content">
        <div id="sidebar_animate" class="sidebar">
            ...
            <ul>
                ...
                <form id="report" method="post" target="_blank" action="msc_report_generator.php">
                    ...
                    <input type="hidden" id="engo605_reports" name="engo605_reports">
                    <input type="hidden" id="engo605_seminar" name="engo605_seminar">
        ...
        <div id="content">
            ...
            <h1><a href="student_dashboard.php" class="breadcrumbs">Student
                Dashboard</a> > MSc Examination Clearance Report</h1>
            ...
            <div id="dynamic">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tr>
                        ...
                        <th>ENGO 605 Seminar Reports</th>
                        <th>ENGO 605 Presentation Completed</th>
                        <th>Final Defense</th>
                        <th>End Date</th>
                    </tr>
                    </thead>
