...
<head>
    ...
    <title>MEng Examination Report</title>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            oTable = $('#example').dataTable({
                ...
                "sAjaxSource":"meng_examination_process.php",
                "sScrollX":"100%",
                //"sScrollXInner": "150%",
        ...
        function getSelectedInfo() {
            ...
            var infoArray = [selected_id, selected_first_name, selected_last_name, selected_final_gpa,
                selected_course_requirement, selected_technical_writing, selected_supervisor];
            return infoArray;
        }
    ...
    <div id="site_content">
        <div id="sidebar_animate" class="sidebar">
            ...
            <ul>
                ...
                <form id="report" method="post" target="_blank" action="meng_report_generator.php">
        ...
        <div id="content">
            ...
            <h1><a href="student_dashboard.php" class="breadcrumbs">Student
                Dashboard</a> > MEng Examination Clearance Report</h1>
