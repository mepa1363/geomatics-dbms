...
$proposal_approval = $_POST['proposal_approval'];
...
<div id="content">
    ...
    <div id="letter_body">
        ...
        <p id="letter_title">The Faculty of Graduate Studies Clearance Memorandum<br>
            for<br>
        ...
        <div id="requirements_section">
            ...
            if ($course_requirement != 'No') {
                ...
                echo "<p id='requirements'>To submit a dissertation proposal, approved by the supervisory committee by $proposal_approval</p>";
                echo "</div>";
            } else {
                echo "<p id='requirements'>ENGO 607 Seminars Complete: $engo607_seminar</p>";
                echo "</div>";
