...
if (isset($_POST['submit'])) {
    ...
    $original_start_date = $_POST['start_date'];
    ...
    if ($major_award_count == 1) {
        ...
        $counter = $major_award_count + 1;
        $major_award_array = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($fgs_award_count == 1) {
        ...
        $counter = $fgs_award_count + 1;
        $fgs_award_array_amount = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($travel_award_count == 1) {
        ...
        $counter = $travel_award_count + 1;
        $travel_award_array_amount = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($travel_award_count == 1) {
        ...
        $counter = $travel_award_count + 1;
        $travel_award_array_claim = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($engo605_seminar_count == 1) {
        ...
        $counter = $engo605_seminar_count + 1;
        $engo605_seminar_array_name = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($engo605_seminar_count == 1) {
        ...
        $counter = $engo605_seminar_count + 1;
        $engo605_seminar_array_date = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($engo607_seminar_count == 1) {
        ...
        $counter = $engo607_seminar_count + 1;
        $engo607_seminar_array_name = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($engo607_seminar_count == 1) {
        ...
        $counter = $engo607_seminar_count + 1;
        $engo607_seminar_array_date = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($engo609_seminar_count == 1) {
        ...
        $counter = $engo609_seminar_count + 1;
        $engo609_seminar_array_name = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    if ($engo609_seminar_count == 1) {
        ...
        $counter = $engo609_seminar_count + 1;
        $engo609_seminar_array_date = array();
        for ($i = 1; $i < $counter; $i++) {
    ...
    $update_query = "UPDATE student_info SET student_id='" . $student_id . "',
     first_name='" . $first_name . "',last_name='" . $last_name . "',gender='" . $gender . "',
     study_type='" . $study_type . "',supervisor_id='" . $supervisor_id . "',cosupervisor_id='" . $co_supervisor_id . "',
     degree_type='" . $degree_type . "',status_in_canada='" . $status_in_canada . "',start_date='" . $original_start_date . "',
     research_stream='" . $research_stream . "',appointment_of_supervisory_committee='" . $appointment_supervisory_committee . "',
     sin_expiry='" . $sin_expiry_date . "',email='" . $email . "',office_location='" . $office_location . "',
     office_tel='" . $office_tel . "',fee_differential_return='" . $fee_differential . "',msc_to_phd='" . $transfer_msc_phd . "',
     entrance_gpa='" . $entrance_gpa . "',final_gpa='" . $final_gpa . "',course_requirements='" . $course_requirements . "',
     course_requirement_completed='" . $course_requirements_completed . "',engo605_presentation_complete='" . $engo605_complete . "',
     engo607_presentation_complete='" . $engo607_complete . "',engo609_presentation_complete='" . $engo609_complete . "',
     major_awards='" . $major_award_collection . "',fgs_award_date='" . $fgs_award_collection_date . "',fgs_award_amount='" . $fgs_award_collection_amount . "',
     travel_award_date='" . $travel_award_collection_date . "',travel_award_amount='" . $travel_award_collection_amount . "',
     travel_award_claim='" . $travel_award_collection_claim . "',technical_writing_complete='" . $writing_complete . "',
     engo_605_seminar_report_name='" . $engo605_seminar_collection_name . "',engo_605_seminar_report_date='" . $engo605_seminar_collection_date . "',
     engo_607_seminar_report_name='" . $engo607_seminar_collection_name . "',engo_607_seminar_report_date='" . $engo607_seminar_collection_date . "',
     engo_609_seminar_report_name='" . $engo609_seminar_collection_name . "',engo_609_seminar_report_date='" . $engo609_seminar_collection_date . "',
     thesis_proposal_approve='" . $thesis_approved . "',candidacy_date='" . $candidacy_exam_date . "',defense_date='" . $final_defense_date . "',
     expected_convocation='" . $expected_convocation_date . "',province_country='" . $original_country . "',last_degree='" . $last_degree . "',
