...
$engo605_reports = $_POST['engo605_reports'];
$engo605_reports = explode(';', $engo605_reports);
$engo605_seminar = $_POST['engo605_seminar'];
...
<div id="content">
    ...
    <div id="letter_body">
        ...
        <p id="letter_title">The Department of Geomatics Engineering Clearance Memorandum<br>
            for<br>Final Oral Examinations M.Sc. Degree
        </p>
        ...
        <div id="requirements_section">
            ...
            <p id="requirements">Completed ENGO 605 Grad Seminar Reports:</p>
            <br>
            <?php
            for ($i = 0; $i < count($engo605_reports); $i++) {
                $num = $i + 1;
                echo "<p id='requirements' style='margin-left: 60px; margin-top: -10px;'>Seminar $num: $engo605_reports[$i]</p>";
                echo "<br>";
            }
            ?>
        </div>
        ...
        <div id="requirements_section">
            ...
            if ($course_requirement != 'No') {
                echo "<p id='requirements'>Completed 5 half-courses, of which at least 4 were graduate courses</p>";
                echo "</div>";

                echo "<div id='requirements_section'>";
                echo "<label id='numbers'>4.</label>";
                echo "<p id='requirements'>ENGO 605 Seminars Complete: $engo605_seminar</p>";
                echo "</div>";
